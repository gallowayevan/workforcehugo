(async function () {
    ...
    const logo = (await d3.svg("/images/assets/sheps_workforce_nc_for_web.svg")).firstChild;
    ...
    function render(data) {
        ...
        d3.select(svg.node().appendChild(logo)).attr("transform", `translate(${width / 2 + 130} ${height - margin.bottom}) scale(0.3) `)
